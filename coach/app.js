...
(function () {
  ...
  function freshCoach() {
    // Opens as the demo coach so a first look lands on a populated Home. "Redo setup" in the game plan runs the onboarding.
    return { onboarded: true, name: "Coach Kurt", ageGroup: D.TEAM.ageGroup, teamLevel: "rec_mixed", experience: "first", worries: ["attention", "meltdowns", "parents"], progress: { onboard: true }, cardsRead: [] };
  }
  ...
  function renderLanding() {
    ...
    return `<div class="landing">
      <section class="hero">
        ...
        <div class="row mt"><span class="chip gold static">${esc(S.team.name)}</span><span class="chip static hero-chip">${esc(g.label)} · ages ${esc(g.ages)}</span><span class="chip static hero-chip">${done} of ${S.players.length} player cards in</span></div>
      </section>
  ...
  function openWelcome() {
    $("#modal-root").innerHTML = `<div class="modal" data-act="close-modal"><div class="box" data-stop>
      ...
      <ol style="margin:8px 0 0 18px;padding:0;display:flex;flex-direction:column;gap:6px"><li><b>Practice:</b> the plan is already built from what the kids asked to work on. Swap a station, change the focus, share it.</li><li><b>Team:</b> open Jaylen or Caleb. See how they want to be coached, star an off-season focus.</li><li><b>Player:</b> switch to the player side (top right), pick Avery, fill out a card, then do a mission.</li><li><b>Learn:</b> open Skill demos for the throwing breakdown and video.</li><li><b>Coach setup:</b> tap "Redo setup" at the bottom of your game plan to see the onboarding a new coach gets.</li></ol>
